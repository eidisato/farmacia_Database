...
import br.org.generation.famarcia.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> getByNomeOuLaboratorio(@PathVariable String nome, @PathVariable String fabricante){
	...
	public ResponseEntity<List<Produto>> getByNomeELaboratorio(@PathVariable String nome, @PathVariable String fabricante){
